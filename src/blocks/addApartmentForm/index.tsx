    ...
    return (
        <div id={id ?? 'add-apartment-form'} className={'2xl:bg-background xl:pb-[80px] xl:pt-[100px] md:pb-[60px] md:pt-[60px] pt-[85px]'}>
            <div className={'container'}>
                <div className={'flex flex-wrap xl:flex-nowrap xl:items-center 2xl:px-[83px] 2xl:py-[80px] xl:px-[62px] xl:py-[60px] 2xl:gap-[80px] 2xl:w-[1075px] md:py-[60px] md:px-[50px] p-[22px] mx-auto bg-white rounded-lg'}>
